...
Esta é uma solução para o desafio do Frontend Mentor [FAQ accordion card main challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/faq-accordion-card-XlyjD0Oam/hub). Os desafios do Frontend Mentor ajudam a melhorar minhas habilidades de codificação criando projetos realistas.
...
- Visualizar os hover states
- Visualizar o correto funcionamento do accordion
...
- URL da solução: [Github](https://github.com/BraynnerM/faq-accordion-card-main)
-  URL do site no Github Pages: [FAQ accordion card main](https://braynnerm.github.io/faq-accordion-card-main//)
